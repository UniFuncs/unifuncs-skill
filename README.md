...
| 深度搜索 | `unifuncs-search/` | 高速全面的深度信息搜索 | ds、深度搜索、deep search |
| 深度研究 | `unifuncs-research/` | 多轮迭代研究，产出万字报告 | dr、深度研究、研究报告 |
...
cp -r /tmp/unifuncs-skill/unifuncs-research ~/.claude/skills/
```
...
cp -r unifuncs-research ~/.claude/skills/
```
